            ...
            <div class='container' id='content'>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="TextBoxEmail" runat="server" CssClass="string email required" Height="3%"
                                    ValidationGroup="SignUpGroup" TabIndex="1"></asp:TextBox>
                ...
                <div class="control-group password required">
                    <label class="password optional control-label">
                        Password</label>
                    <div class="controls">
                        <asp:TextBox ID="TextBoxPassword" runat="server" TextMode="Password" Height="3%"
                            ValidationGroup="SignUpGroup" TabIndex="2"></asp:TextBox>
                ...
                <div class="control-group password required">
                    ...
                    <div class="controls">
                        <asp:TextBox ID="TextBoxConfirmPassword" runat="server" TextMode="Password" Height="3%"
                            ValidationGroup="SignUpGroup" TabIndex="3"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="TextBoxConfirmPassword"
                            ErrorMessage="Please enter password confirmation." ForeColor="#FF0000" ValidationGroup="SignUpGroup"
                            runat="server" />
                        <br />
                ...
                <div class="control-group string required">
                    ...
                    <div class="controls">
                        <asp:TextBox ID="TextBoxCreditCardNumber" runat="server" Height="3%" ValidationGroup="SignUpGroup"
                ...
                <div class="control-group select required">
                    <label class="select required control-label">
                        Credit Card Expire Month</label>
                    <div class="controls">
                ...
                <div class='form-actions'>
                    <asp:Button ID="ButtonSignUp" runat="server" CssClass="btn btn btn-primary" Text="SignUp"
                        Height="3%" ValidationGroup="SignUpGroup" TabIndex="9" OnClick="ButtonSignUp_Click" />
                </div>
            </div>
